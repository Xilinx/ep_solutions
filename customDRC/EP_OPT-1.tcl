# This DRC flags the number of nets with the property DONT_TOUCH=1
...
proc [lindex $DRCINFO 0] {} {
  ...
  set vios [list]
  # DRC code
  set nets [get_nets -quiet -hier -filter {DONT_TOUCH==1}]; llength $nets
  if {[llength $nets]} {
    set msg "Property DONT_TOUCH found on [llength $nets] nets"
