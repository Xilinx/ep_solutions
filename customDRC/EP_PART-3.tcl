# This DRC flags the number of hierarchical modules with the property USER_CLUSTER
...
set DRCINFO [list \
  ...
  {Property USER_CLUSTER on hierarchical modules} \
  {Advisory}
  ]
...
proc [lindex $DRCINFO 0] {} {
  ...
  set vios [list]
  # DRC code
  set cells [get_cells -quiet -hier -filter {USER_CLUSTER != {}}] ; llength $cells
  if {[llength $cells]} {
    set msg "Property USER_CLUSTER found on [llength $cells] hierarchical modules"
